...
?>
<h1><?php echo $MSG_EDIT.$MSG_PROBLEM?></h1>
...
?>
<p><?PHP ECHO $MSG_PROBLEM."ID:". $row->problem_id?></p>
<input type=hidden name=problem_id value='<?php echo $row->problem_id?>'>
<p><?PHP ECHO $MSG_TITLE.":"?><input type=text name=title size=71 value='<?php echo htmlentities($row->title,ENT_QUOTES,"UTF-8")?>'></p>
<p><?PHP echo $MSG_Time_Limit.":"?><input type=text name=time_limit size=20 value='<?php echo $row->time_limit?>'>S</p>
<p><?PHP echo $MSG_Memory_Limit.":"?><input type=text name=memory_limit size=20 value='<?php echo $row->memory_limit?>'>MByte</p>
...
<p><?php echo $MSG_Sample_Input.":"?><br><textarea rows=13 name=sample_input cols=120><?php echo htmlentities($row->sample_input,ENT_QUOTES,"UTF-8")?></textarea></p>
<p><?php echo $MSG_Sample_Output.":"?><br><textarea rows=13 name=sample_output cols=120><?php echo htmlentities($row->sample_output,ENT_QUOTES,"UTF-8")?></textarea></p>
