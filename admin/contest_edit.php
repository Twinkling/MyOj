...
<p align=left><?php echo $MSG_DATE_ARRAY["StartTime"].":"?><br>&nbsp;&nbsp;&nbsp;
	<?php echo $MSG_DATE_ARRAY["Year"].":"?><input class=input-mini  type=text name=syear value=<?php echo substr($starttime,0,4)?> size=4 >
	<?php echo $MSG_DATE_ARRAY["Month"].":"?><input class=input-mini  type=text name=smonth value='<?php echo substr($starttime,5,2)?>' size=2 >
	<?php echo $MSG_DATE_ARRAY["Day"].":"?><input class=input-mini  type=text name=sday size=2 value='<?php echo substr($starttime,8,2)?>'>
	<?php echo $MSG_DATE_ARRAY["Hour"].":"?><input class=input-mini  type=text name=shour size=2 value='<?php echo substr($starttime,11,2)?>'>
	<?php echo $MSG_DATE_ARRAY["Minute"].":"?><input class=input-mini  type=text name=sminute size=2 value=<?php echo substr($starttime,14,2)?>></p>
<p align=left><?php echo $MSG_DATE_ARRAY["EndTime"].":"?><br>&nbsp;&nbsp;&nbsp;

	<?php echo $MSG_DATE_ARRAY["Year"].":"?><input class=input-mini  type=text name=eyear value=<?php echo substr($endtime,0,4)?> size=4 >
	<?php echo $MSG_DATE_ARRAY["Month"].":"?><input class=input-mini  type=text name=emonth value=<?php echo substr($endtime,5,2)?> size=2 >
	<?php echo $MSG_DATE_ARRAY["Day"].":"?><input class=input-mini  type=text name=eday size=2 value=<?php echo substr($endtime,8,2)?>>
	<?php echo $MSG_DATE_ARRAY["Hour"].":"?><input class=input-mini  type=text name=ehour size=2 value=<?php echo substr($endtime,11,2)?>>
	<?php echo $MSG_DATE_ARRAY["Minute"].":"?><input class=input-mini  type=text name=eminute size=2 value=<?php echo substr($endtime,14,2)?>></p>

	<?php echo $MSG_Public."/".$MSG_Private.":"?><select name=private>
...
<br><?php echo $MSG_PROBLEM.":"?><input class=input-xxlarge type=text size=60 name=cproblem value='<?php echo $plist?>'>
...
<p align=left><?php echo $MSG_Description.":"?><br><textarea class="kindeditor" rows=13 name=description cols=80><?php echo htmlentities($description,ENT_QUOTES,"UTF-8")?></textarea>
	...
	<?php echo $MSG_USER.":"?><textarea name="ulist" rows="20" cols="20"><?php if (isset($ulist)) { echo $ulist; } ?></textarea>
